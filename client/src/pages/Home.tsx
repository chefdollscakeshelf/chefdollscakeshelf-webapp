/* =============================================================
   Home — Landing page for ChefDollsCakeShop
...
function FeatureCard({
  ...
  return (
    <div
      ...
      style={{ background: feature.bg, border: `1.5px solid ${feature.border}` }}
    >
      ...
      <Link
        ...
        style={{ color: feature.accent, fontFamily: "var(--font-body)", textDecoration: "none" }}
      >
        {feature.cta}
...
function HomeOrderCTA() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting && ref.current) ref.current.classList.add("visible");
        });
      },
      { threshold: 0.1 }
    );
  ...
  return (
    <section className="py-16 md:py-20" style={{ background: "oklch(0.99 0.01 80)" }}>
      <div className="container">
        <div
          ref={ref}
        ...
        >
          ...
          <div className="relative z-10">
            <p className="font-script text-2xl mb-2" style={{ color: "oklch(0.95 0.03 60)" }}>
            ...
            >
              Custom cakes need 5–7 days notice. Cupcakes &amp; pastries just 48 hours.
